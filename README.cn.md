...
[![x-cmd/install — podliner Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/podliner.svg?lang=zh)](https://x-cmd.com/install/podliner)
...
合计: **31,370** 行代码（覆盖前 5 种语言、共 **287** 个文件）。
...
- **上游仓库**: <https://github.com/timkicker/podliner>
- **许可证**: GPL-3.0

## 发布

- **最新版本**: `v2.0.1` (2026-09-14)
- **最近提交**: 2026-09-14
- **Release 含资产**: 10 个

## 流行度

- **Star**: 173 · **Fork**: 8 · **开放 issue**: 23 · **贡献者**: 3

## 累计统计

- **发布数**: 47 · **已合并 PR**: 8 · **开放 PR**: 0 · **已关闭 issue**: 22 · **开放 issue**: 1 · **提交数**: 266

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 2 | 5 | 0 | 0 | 0 | 52 |
| last60d | 2026-07-26 | 2 | 5 | 0 | 0 | 0 | 52 |
| 90d | 2026-06-26 | 2 | 5 | 0 | 0 | 0 | 52 |
| last180d | 2026-03-28 | 5 | 5 | 0 | 4 | 0 | 76 |
| 360d | 2025-09-29 | 47 | 8 | 0 | 22 | 1 | 211 |
| last720d | 2024-10-04 | 47 | 8 | 0 | 22 | 1 | 266 |
...
podliner 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `podliner` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/podliner.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:01:35Z._
